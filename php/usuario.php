        ...
        <div class="contenedor">
            ...
            <nav class="nav" id="nav">
                <ul class="menu">
                    ...
                    <li class="menu__item"><a class="menu__link select" href="../php/usuario.php">Iniciado</a> </li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="contenedor">
            <section class="info">
                <article class="info__columna">
                    ...
                    <p>Experiencia con niños recien nacidos a 3 años</p>
                ...
                <article class="info__columna">
                    ...
                    <p>Experiencia con niños de 1 a 3 años</p>
                    <p>$30 la hora por niño</p>
                </article>
                <article class="info__columna">
                    ...
                    <p>Experiencia con niños de 2 a 6 años</p>
                    <p>$30 la hora por niño</p>
                </article>
            </section>
        </div>
